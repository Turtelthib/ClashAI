...
#
# Usage :
#   python scripts/rl/calibrate_ui.py              (calibration complète)
#   python scripts/rl/calibrate_ui.py --only chat   (recalibrer seulement le chat)
#   python scripts/rl/calibrate_ui.py --show        (afficher les positions actuelles)
#
# Méthode :
