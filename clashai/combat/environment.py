...
class ClashEnvV3:
    ...
    def _check_battle_end(self):
        """V3 episode lifecycle — impl in clashai.combat.episode_lifecycle."""
        from clashai.combat.episode_lifecycle import check_battle_end
        return check_battle_end(self)
    ...
    def _finish_episode(self):
        """V3 episode lifecycle — impl in clashai.combat.episode_lifecycle."""
        from clashai.combat.episode_lifecycle import finish_episode
        return finish_episode(self)

    def _wait_for_battle_end(self):
        """V3 episode lifecycle — impl in clashai.combat.episode_lifecycle."""
        from clashai.combat.episode_lifecycle import wait_for_battle_end
        return wait_for_battle_end(self)

    def _compute_reward(self, stars, percentage):
        """V3 reward — impl in clashai.combat.episode_lifecycle.compute_reward."""
        from clashai.combat.episode_lifecycle import compute_reward
        return compute_reward(stars, percentage)
    ...
    def get_heuristic_sequence(self):
        """
        Heuristic sequence V3 — implementation in clashai/combat/heuristic_v3.py
